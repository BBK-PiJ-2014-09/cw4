...
/**
  ...
  * @param id the ID for the meeting * @return the meeting with the requested ID, or null if it there is none. 
...
/** 
  ...
  * @param id the ID of the meeting * @param text messages to be added about the meeting. 
